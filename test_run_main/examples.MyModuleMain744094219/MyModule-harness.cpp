...
#endif
#include <iostream>
class MyModule_api_t: public sim_api_t<VerilatorDataWrapper*> {
    public:
    MyModule_api_t(VMyModule* _dut) {
        dut = _dut;
        main_time = 0L;
        is_exit = false;
#if VM_TRACE
    ...
    void init_sim_data() {
        ...
        sim_data.signal_map["MyModule.reset"] = 0;
    }
#if VM_TRACE
...
static MyModule_api_t * _Top_api;
...
int main(int argc, char **argv, char **env) {
    ...
    std::string vcdfile = "test_run_dir/examples.MyModuleMain744094219/MyModule.vcd";
